...
<!-- ReAct · MCP · ACP · SKILL.md · AGENTS.md · 5 agents -->
...
<div class="eyebrow">Instruction LLM</div>
...
<!-- GPT-3 2020 · InstructGPT · ChatGPT 2022.11.30 -->
...
<!-- CoT · Wei 2022.01 · Kojima 2022.05 · o1 · R1 · extended thinking -->
...
<p class="small" style="text-align:center;">
<span style="color:var(--accent-1);font-family:var(--font-label);letter-spacing:.08em;text-transform:uppercase;">function calling · OpenAI · 2023.06.13</span>
</p>

<!-- WebGPT 2021 · Toolformer 2023 · function calling 2023.06.13 -->
...
## <span class="title">12-Factor Agents.</span>
...
<div class="two-col">
  ...
  <div style="align-self:center;">
    <p class="lede" style="font-family:var(--font-serif);font-style:italic;line-height:1.25;">
      <span style="color:var(--accent-1);">orchestration</span>: small<br />
      <span style="color:var(--accent-1);">integration</span>: rich
    </p>
...
<!-- enforce structurally, not by prompt -->
...
<div class="eyebrow">AI agent · 2026</div>
...
<div style="display:grid;grid-template-columns:repeat(2, 1fr);column-gap:80px;row-gap:18px;font-size:28px;">
  ...
  <div style="display:grid;grid-template-columns:60px 1fr;align-items:baseline;gap:18px;padding-bottom:14px;border-bottom:1px solid var(--line-soft);">
    ...
    <span>MCP <em style="color:var(--muted);">or</em> explicit refusal</span>
  </div>
  <div style="display:grid;grid-template-columns:60px 1fr;align-items:baseline;gap:18px;padding-bottom:14px;border-bottom:1px solid var(--line-soft);">
