...
style: |
  ...
  /* STYLE.md — color accent, no italic */
...
<span style="color:var(--muted);font-size:0.6em;">남은 것은 <em>editorial</em>.</span>
</p>

<!-- 합의된 architecture · 남은 차이는 editorial -->
...
<div class="two-col" style="gap:60px;">
  <div>
    ...
    <div class="card" style="font-family:var(--font-mono);font-size:24px;line-height:1.6;">
      ...
      <div>오늘 날씨는</div>
      <div style="color:var(--accent-1);margin-top:14px;">→ 맑고 화창합니다…</div>
    </div>
  </div>
  <div>
    ...
    <div class="card" style="font-family:var(--font-mono);font-size:24px;line-height:1.6;">
      <div style="color:var(--muted);font-size:24px;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:18px;">prompt</div>
      <div>메일 정리해줘.</div>
      <div style="color:var(--accent-1);margin-top:14px;">→ 어떤 기준으로?</div>
    </div>
  </div>
</div>
...
<!-- GPT-3 2020 → ChatGPT Nov 2022 · interface 의 변화 -->
...
<div style="display:grid;grid-template-columns:1fr 1.2fr;gap:80px;align-items:center;">
  <svg viewBox="0 0 640 480" style="width:100%;height:auto;">
    ...
    <text x="50" y="102" class="label" style="font-size:26px;">규칙</text>
    ...
    <text x="50" y="246" class="label" style="font-size:26px;">사용자 입력</text>
    ...
    <text x="50" y="390" class="label" style="font-size:26px;fill:var(--bg);">모델 응답</text>
  </svg>
  <div>
...
<!-- CoT 2022 → o1 Sep 2024 → R1 Jan 2025 → Claude extended thinking Feb 24 2025 -->
...
<!-- WebGPT · Toolformer · function calling Jun 13 2023 -->
...
<!-- ReAct = Reasoning + Acting · Princeton/Google -->
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;margin-top:32px;">
  ...
  <div style="align-self:end;">
    ...
    <p class="small">AutoGPT stars / 13 days · 100K · weeks later</p>
  </div>
</div>

<!-- 연구 → product category · 6개월 -->
...
<div class="two-col">
  ...
  <div style="align-self:center;">
    <p class="lede" style="line-height:1.25;">
      <span class="accent">orchestration</span> 작게<br />
      <span class="accent">integration</span> 풍부하게
    </p>
...
<!-- framework wars 정리 · MCP가 integration layer를 standardize -->
...
<!-- AAIF · Anthropic + OpenAI + Block + Google + Microsoft + AWS + Bloomberg -->

---

<div class="eyebrow">어떻게 맞물리나</div>
...
<p class="small" style="color:var(--muted);text-align:center;">
swappable layers · LSP for editors와 같은 모양
</p>

<!-- 어느 layer를 바꿔도 나머지는 그대로 -->
...
<!-- 같은 SKILL.md → claude-code, Codex, Cursor, OpenCode, Pi, Goose, ~25 tools -->
...
<!-- 같은 loop · prompt + tool filter + permission으로 reconfigure -->
...
<!-- 5개 agents 모두 공유 · 더 이상 designer들이 differ하지 않는 부분 -->
...
<table class="deck" style="font-size:28px;">
  <tbody>
    <tr>
      <td style="text-align:right;">Server-first</td>
      <td class="ar">vs</td>
      <td>Binary-first</td>
    </tr>
    <tr>
      <td style="text-align:right;"><code>MCP</code> built-in</td>
      <td class="ar">vs</td>
      <td><code>MCP</code> via bridge</td>
    </tr>
    <tr>
      <td style="text-align:right;">Sandbox in core</td>
      <td class="ar">vs</td>
      <td>Sandbox in deployment</td>
    </tr>
    <tr>
      <td style="text-align:right;">Curated memory</td>
      <td class="ar">vs</td>
      <td>Stateless session</td>
    </tr>
    <tr>
      <td style="text-align:right;">Subagents first-class</td>
      <td class="ar">vs</td>
      <td>Single agent</td>
    </tr>
    <tr>
      <td style="text-align:right;">Multi-tenant</td>
      <td class="ar">vs</td>
...
<!-- 6 editorial 선택 · 각 agent가 한쪽을 택함 -->
...
<!-- 5 layers · 같은 architecture · 다른 setup -->
...
<table class="deck" style="font-size:28px;">
  ...
  <tbody>
    <tr>
      <td>혼자 개발, hand-buildable</td>
      <td class="ar">→</td>
      <td class="k">pi-mono</td>
    </tr>
    <tr>
      <td>Platform 형태의 coding agent</td>
      <td class="ar">→</td>
      <td class="k">claude-code</td>
    </tr>
    <tr>
      <td>어디서나 — terminal · web · IDE · mobile</td>
      <td class="ar">→</td>
      <td class="k">opencode</td>
    </tr>
    <tr>
      <td>Chat-platform assistant, single-operator</td>
      <td class="ar">→</td>
      <td class="k">openclaw</td>
    </tr>
    <tr>
      <td>Self-improving + training environment</td>
      <td class="ar">→</td>
      <td class="k">hermes-agent</td>
    </tr>
  </tbody>
...
<p class="small" style="color:var(--muted);text-align:center;">
어떤 agent가 best인가 X · 어떤 problem class에 있는가 O.
</p>
