...
style: |
  ...
  /* Color-only accent (no italic) — STYLE.md emphasis device */
  .accent { color: var(--accent-1); }
  /* Inline code / mono — STYLE.md backtick treatment for protocols & file artifacts */
  ...
  /* Color-only accent (no italic) per STYLE.md */
  ...
  /* Italic, no quotes — STYLE.md pull-quote */
...
<!-- Modern AI Agents · 60 min · May 2026 -->
...
<!-- 3 threads · Transformer 2017 · → 2026 agents -->
...
<p class="hero-text">
Same <em>structure</em>.<br />
Different <em>surface</em>.
</p>

<!-- settled architecture · varied setup -->
...
<div class="two-col" style="gap:60px;">
  <div>
    <div class="col-head"><span class="dot" style="background:var(--muted);"></span><span>2018</span></div>
  ...
  <div>
    <div class="col-head"><span class="dot"></span><span>2022</span></div>
    <div class="card" style="font-family:var(--font-mono);font-size:24px;line-height:1.6;">
      <div style="color:var(--muted);font-size:24px;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:18px;">prompt</div>
...
<!-- GPT-3 2020 · InstructGPT · ChatGPT Nov 2022 -->
...
## <span class="title">Reasoning emerged.</span>
...
<svg viewBox="0 0 1680 360" style="width:100%;height:auto;">
  ...
  <text x="1420" y="198" text-anchor="middle" style="fill:var(--bg);font-family:var(--font-label);font-size:24px;opacity:.85;">agent capability</text>
</svg>

<!-- CoT · Wei · Kojima · 2022 → o1 · R1 · extended thinking -->
...
<p class="small" style="text-align:center;">
<span style="color:var(--accent-1);font-family:var(--font-label);letter-spacing:.08em;text-transform:uppercase;">function calling · OpenAI · Jun 2023</span>
</p>

<!-- WebGPT · Toolformer · function calling Jun 2023 -->
...
<div style="display:grid;grid-template-columns:1.1fr 1fr;gap:80px;align-items:center;">
  ...
  <div>
    <p class="lede" style="margin-bottom:32px;">1 turn = 1 model call.</p>
    <p class="small" style="color:var(--accent-1);font-family:var(--font-label);letter-spacing:.08em;text-transform:uppercase;">
...
## <span class="title">2023 — orchestration wave.</span>
...
<!-- LangChain · AutoGPT · BabyAGI · AutoGen · CrewAI · MCP -->

---

<div class="eyebrow">Wave 이후</div>

## <span class="title"><span class="accent">12-Factor</span> Agents.</span>
...
<div class="two-col">
  ...
  <div style="align-self:center;">
    <p class="lede" style="line-height:1.25;">
      ...
      <span class="accent">integration</span>: rich
    </p>
...
<div class="two-col">
  <div>
    ...
    <ul class="bare" style="margin-top:18px;font-size:28px;line-height:1.5;">
      ...
      <li style="padding:18px 0;">Permission prompt</li>
    </ul>
  </div>
  <div>
...
<!-- 구조로 enforce, prompt로 부탁 X -->

---

<div class="eyebrow">12 months</div>

## <span class="title">Four standards.</span>
...
<div class="standards-row">
  ...
  <div class="std-card">
    ...
    <div class="s-date">Codex CLI · mid-2025</div>
  </div>
  <div class="std-card">
...
<!-- MCP · AGENTS.md · ACP · SKILL.md · 12 months -->
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;margin-top:24px;align-items:center;">
  <div>
    <div style="font-family:var(--font-mono);font-size:40px;line-height:1.4;color:var(--fg);">
      30 × 100<br /><span style="color:var(--accent-3);">≈ 3K tokens</span>
    </div>
  </div>
  <div>
...
<!-- claude-code · opencode · openclaw · hermes-agent · pi-mono -->
...
<!-- shared SKILL.md · ACP fan-out · pi embed · openclaw → hermes -->
...
<div class="rifts">
  ...
  <div class="l"><code>MCP</code> built-in</div> <div class="mid">vs</div> <div class="r"><code>MCP</code> via bridge</div>
  <div class="row-line"></div>
  <div class="l">Sandbox in core</div>  <div class="mid">vs</div> <div class="r">Sandbox in deployment</div>
  <div class="row-line"></div>
  <div class="l">Curated memory</div> <div class="mid">vs</div> <div class="r">Stateless session</div>
  <div class="row-line"></div>
...
<div class="eyebrow">Canonical shape</div>

## <span class="title"><span class="accent">AI agent란?</span> — 2026.</span>
...
<div class="eyebrow">Pick the setup</div>
...
<div class="branches">
  <div class="branch">
    <div class="q">Solo, hand-buildable</div>
    <div class="ar">→</div>
    <div class="a">pi-mono</div>
  </div>
  <div class="branch">
    <div class="q">Coding agent as platform</div>
    <div class="ar">→</div>
    <div class="a">claude-code</div>
  </div>
  <div class="branch">
    <div class="q">Everywhere — terminal · web · IDE · mobile</div>
    <div class="ar">→</div>
    <div class="a">opencode</div>
  </div>
  <div class="branch">
    <div class="q">Chat-platform assistant, single-operator</div>
    <div class="ar">→</div>
    <div class="a">openclaw</div>
  </div>
  <div class="branch">
    <div class="q">Self-improving + training environment</div>
    <div class="ar">→</div>
    <div class="a">hermes-agent</div>
  </div>
</div>
...
<p class="subtitle" style="text-align:center;margin:0 auto;font-style:normal;">Q&amp;A</p>
